...
@PageTitle("Usuarios")
@Route(value = "card-list/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@Uses(Icon.class)
public class UsuariosView extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "card-list/%s/edit";
    ...
    public UsuariosView(SamplePersonService samplePersonService) {
